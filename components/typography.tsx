...
export function TypographyH2({ children, className, id }: TypographyProps) {
	return (
		<h2
			id={id}
			className={cn(
				"scroll-m-20 pb-2 mb-4 font-bold tracking-tight text-foreground text-4xl md:text-6xl tracking-tight first:mt-0",
				className,
			)}
		>
			{children}
...
export function TypographyLead({ children, className }: TypographyProps) {
	return (
		<p
			className={cn(
				"mt-5 text-lg md:text-xl text-muted-foreground mx-auto leading-normal",
				className,
			)}
		>
			{children}
