				...
				<div className="pt-32 pb-16 md:pt-52 md:pb-32">
					...
					<div className="max-w-3xl mx-auto text-center">
						...
						<h1
							...
							data-aos="fade-down"
						>
							Unlimited Design, Rapid App Development—One Plan
						</h1>
						<p
							...
							data-aos-delay="200"
						>
							Elevate your digital presence with custom UI/UX design and
							seamless AI integrations—all under a single, affordable plan. From
