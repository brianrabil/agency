import { ArrowRightIcon } from "lucide-react"; // Lucide icon with "Icon" suffix
				...
				<div className="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
					...
					>
						<svg xmlns="http://www.w3.org/2000/svg" width="434" height="427">
							<title>CTA background illustration</title>
							<defs>
								<linearGradient
									id="bs5-a"
									x1="19.609%"
					...
					<div className="max-w-3xl mx-auto text-center">
						...
						<p className="text-lg text-slate-400 mb-8">
							Subscribe to get the latest updates on Zendrel's unlimited UI/UX
							and AI features, designed to empower your creative workflow.
						</p>
